            ...
            while (true) {
                ...
                for (int i = 0; i < items.getLength(); i++) {
                    ...
                    if (node.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        System.out.println("제목 : " + getString(e, "TITLE"));
                        System.out.println("공고일자 : " + getString(e, "PBANC_YMD"));
                        System.out.println("내용 : " + getString(e, "PBANC_CONT"));
                        System.out.println("담당자 : " + getString(e, "RGSTN_ID"));
                        System.out.println("담당부서 : " + getString(e, "CHRG_DEP"));
                    }
                }
