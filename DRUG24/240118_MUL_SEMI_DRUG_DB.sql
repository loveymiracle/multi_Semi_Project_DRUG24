...
CREATE TABLE MedicineReply (
	...
	CREATE_DATE DATETIME DEFAULT CURRENT_TIMESTAMP,
	FOREIGN KEY(mNO) REFERENCES MEMBER(mNO),
    FOREIGN KEY(dNO) REFERENCES MEDICINE(dNO)
);

INSERT INTO MedicineReply (rNO, mNO, dNO, CONTENT, RATING) VALUES(0, 2, 195700020, '소화 불량엔 역시', 5);
INSERT INTO MedicineReply (rNO, mNO, dNO, CONTENT, RATING) VALUES(0, 2, 195700020, '날마다 복용잘하고 있습니다! 고맙습니다!',5);
