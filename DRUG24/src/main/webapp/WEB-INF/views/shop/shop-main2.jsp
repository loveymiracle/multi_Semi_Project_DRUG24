						...
						<nav aria-label="breadcrumb">
							<ol
								...
								<li class="breadcrumb-item text-nowrap"><a
									href="home-marketplace.html">Market</a></li>
							</ol>
						</nav>
					</div>
				...
				<div class="d-flex align-items-center ps-2">
					...
					<div class="d-flex align-items-center">
						<div class="dropdown py-4 border-start">
							<div class="nav-link-style fs-md fw-medium dropdown-toggle p-4" data-bs-toggle="dropdown"><span class="custom-select-text d-inline-block py-1"><i class="ci-thumb-up align-middle opacity-60 mt-n1 me-2"></i>추천</span>
		                		<ul class="custom-select-list dropdown-menu dropdown-menu-end">
				                  <li value="normal" class="custom-select-option"><a class="dropdown-item"><i class="ci-thumb-up me-2 opacity-60"></i>추천</a></li>
				                  <li value="low" class="custom-select-option"><a class="dropdown-item"><i class="ci-arrow-down me-2 opacity-60"></i>낮은 가격</a></li>
				                  <li value="high" class="custom-select-option"><a class="dropdown-item"><i class="ci-arrow-up me-2 opacity-60"></i>높은 가격</a></li>
				                </ul>
								<select name="sort" class="select-form" style="display:none;" onchange="document.searchForm.submit();">
...
<script type="text/javascript">
		...
		$('custom-select-option').on('click', function() {
			...
			$('.select-form').val(value);
			$('.custom-select-list').hide();
			
			$('.select-form').find('option').each(function(index, el) {
