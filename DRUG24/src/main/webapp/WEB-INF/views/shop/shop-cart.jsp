        ...
        <div class="row">
          ...
          <section class="col-lg-8">
            ...
            <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
              <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="{path}/shop/product?pno=${item.pno}"><img src="${item.image }" width="160" alt="Product"></a>
                <div class="pt-2">
                  <h3 class="product-title fs-base mb-2"><a href="${path}/shop/product?pno=${item.pno}">${item.title }</a></h3>
                  <div class="fs-lg text-accent pt-2"><fmt:formatNumber value="${item.lprice }" pattern="#,###" />원</div>
                </div>
              </div>
              <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start" style="max-width: 9rem;">
                <label class="form-label" for="quantity1">Quantity</label>
                <input class="form-control" type="number" id="quantity1" min="1" value="${item.amount }">
                <button class="btn btn-link px-0 text-danger" type="button" onclick="cartDelete('${item.pno}', '/shop/cart');"><i class="ci-close-circle me-2"></i><span class="fs-sm">Remove</span></button>
              </div>
            </div>
            </c:forEach>
